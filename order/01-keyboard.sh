...
DIALOG_HEIGHT=10
DIALOG_WIDTH=40
PROMPT_MESSAGE="Please enter your keymap:"
INITIAL_INPUT="us" # Optional: default value
...
USER_INPUT=$(dialog --title "Setting up keymaps..." \
                    --clear \
...
case $response in
  0)
    echo "SYS_KEYMAP='$USER_INPUT'" > hostname.txt_config
    bash list.sh
    ;;
  1)
