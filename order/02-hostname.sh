...
DIALOG_HEIGHT=10
DIALOG_WIDTH=40
PROMPT_MESSAGE="Please enter your hostname:"
...
USER_INPUT=$(dialog --title "Setting up Hostname..." \
                    --clear \
...
case $response in
  0)
    echo "Hello, $USER_INPUT. OK was pressed."
    echo "SYS_HOSTNAME='$USER_INPUT'" > hostname.txt_config
    bash list.sh
    ;;
  1)
