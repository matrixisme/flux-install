...
DIALOG_HEIGHT=10
DIALOG_WIDTH=40
PROMPT_MESSAGE="Please enter your locale (ONLY UTF8 ENCODING):"
INITIAL_INPUT="en_US" # Optional: default value
...
USER_INPUT=$(dialog --title "Setting up locale..." \
                    --clear \
...
case $response in
  0)
    echo "SYS_LOCALE='$USER_INPUT.UTF8'" > locale.txt_config
    bash list.sh
    ;;
  1)
