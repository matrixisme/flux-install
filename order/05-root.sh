...
DIALOG_HEIGHT=10
DIALOG_WIDTH=40
PROMPT_MESSAGE="Please enter your password for root:"
INITIAL_INPUT="" # Optional: default value
...
USER_INPUT=$(dialog --title "Setting up root password..." \
                    --clear \
...
case $response in
  0)
    echo "SYS_ROOTPASSWD='$USER_INPUT'" > root.txt_config
    bash list.sh
    ;;
  1)
