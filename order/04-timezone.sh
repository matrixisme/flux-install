...
DIALOG_HEIGHT=10
DIALOG_WIDTH=40
PROMPT_MESSAGE="Please enter your time zone:"
INITIAL_INPUT="America/Hawaii" # Optional: default value
...
USER_INPUT=$(dialog --title "Setting up Time Zone..." \
                    --clear \
...
case $response in
  0)
    echo "SYS_TIMEZONE='$USER_INPUT'" > zoneinfo.txt_config
    bash list.sh
    ;;
  1)
